...
class ModelParams(ParamGroup): 
    def __init__(self, parser, config, sentinel=False):
        ...
        self.flow_model_ckpt = './RAFT/models/Tartan-C-T-TSKH-spring540x960-M.pth'
        self.flow_config = "./RAFT/config/eval/spring-M.json"
        self.sam2_checkpoint = "./sam2/checkpoints/sam2.1_hiera_large.pt" 
        self.sam2_model_cfg = "./sam2.1/sam2.1_hiera_l.yaml"
        ...
        self.flow_thresh1 = 1.5 #0.25 #2.0
        self.flow_thresh2 = 0.75 #0.25 #2.0
        self.flow_views = [1, 4, 8, 13] 
        self.flow_offset = 3
        self.keyframe_offset_op = 1
        self.keyframe_offset_sam = 5
        ...
        self.dynamic_update_thresh = 0.1 
        ...
        self.frz_f_dc = "st"#"none"  
        self.frz_f_rest = "st" #"none"  
        self.frz_sc = "st"  
        self.frz_rot = "st" 
        self.frz_op = "st"  
        self.frz_flow = "none"
...
class OptimizationParamsRest(ParamGroup):
    def __init__(self, parser, config):
        ...
        self.motion_label_from_iter_rest = 6000
        self.motion_label_until_iter_rest = 10000        
        ...
        self.motion_label_lr_rest = 0.01 #0.01 0.05
        self.ntc_lr_rest = 0.002
        ...
        self.motion_label_ldecs_lr_rest = 1.0e-4
        ...
        self.motion_label_lr_scaling_rest = 1.0
        self.offset_lr_scaling_rest = 1.0
        
        
        self.lambda_depthOderLoss_rest = 0.0
        self.lambda_MotionMaskLoss_rest = 0.3

        self.densify_until_iter_rest = 15000
        self.densify_from_iter_rest = 500
        
        self.ntc_conf_path_rest = "/SSD1/WONJOON/MoRGS/configs/cache_F_4.json"

        self.lambda_offset_rest = 0.01
        self.offset_lr_init_rest = 1e-4
        self.offset_lr_final_rest = 1e-6
        self.offset_lr_delay_mult_rest = 0.01
        self.offset_lr_max_steps_rest = 30_000
    ...
    def extract(self, args):
        ...
        g.latents_lr_scaling_rest = [g.xyz_lr_scaling_rest, 
                                   ...
                                   g.motion_label_lr_scaling_rest]
...
class OptimizationParamsInitial(ParamGroup):
    def __init__(self, parser, config):
        ...
        self.motion_label_lr = 0.01 #0.01
        self.ntc_lr = 0.002
        ...
        self.depth_until_iter = 10000
        self.motion_label_from_iter = 6000
        self.motion_label_until_iter = 10000
        ...
        self.motion_label_ldecs_lr = 1.0e-4
        ...
        self.motion_label_lr_scaling = 1.0
        self.offset_lr_scaling = 1.0
        
        self.lambda_depthOderLoss = 0.0
        self.lambda_MotionMaskLoss = 0.3
        
        self.densify_until_iter = 15000
        self.densify_from_iter = 500
        
        self.ntc_conf_path = "/SSD1/wonjoon/queen_ml/configs/cache_F_4.json"
...
class QuantizeParams(PrefixParamGroup): 
    def __init__(self, parser, config, sentinel=False):
        self.latent_dim = [3,1,16,3,4,1,1,3]
        self.latent_norm = ["none", "none", "none", "none", "none", "none", "none", "none"]
        self.quant_type = ['none']*8
        self.latent_scale_norm = ["none"]*8
        self.ldecode_matrix = ["learnable"]*8
        self.use_shift = [1]*8
        self.ldec_std = [1.0]*8
        self.num_layers_dec = [0]*8
        self.hidden_dim_dec = [3,1,16,3,4,1,1,1]
        self.activation = ["relu"]*8
        self.final_activation = ["none"]*8
        self.param_names = ["xyz", "f_dc", "f_rest", "sc", "rot", "op", "motion_label", "flow"]
        self.invert_type = ["dec", "dec", "dec", "dec", "dec", "dec", "dec", "dec"]
        self.freeze_after = [1.0]*8
        self.freeze_before = [0.0]*8
        self.gate_params = ["none"]*8

        self.quant_after = [0.0]*8
